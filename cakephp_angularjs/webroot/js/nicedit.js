...
var nicEditorInstance = bkClass.extend({
    ...
    selected: function (e, t) {
        ...
        if (this.elm.innerHTML !== this.oldValue) {
            this.oldValue = this.elm.innerHTML;
            if (typeof this.ne.options.onChange != 'undefined' && typeof this.ne.options.onChange == 'function')
                this.ne.options.onChange(this.getElm.innerHTML);
        }

        //if (this.oldValue.indexOf(this.elm.innerHTML) < 0)
...
var nicEditorPane = bkClass.extend({
    construct: function (elm, nicEditor, options, openButton) {
        ...
        //this.contain.noSelect().appendTo(document.body);
        this.contain.noSelect().appendBefore(document.getElementById('_fancybox-content'));
    ...
    position: function () {
        if (this.ne.nicPanel) {
            ...
            var panelPos = panelElm.relativePos();
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    ...
    addForm: function () {
        ...
        myDoc.write('<div style="font-size: 14px; font-weight: bold; padding-top: 5px; color: #4d4d4d;font-size:14px; font-family: PMSemi,sans-serif;">Insert an Image</div>');
        myDoc.write('<br>');
        myDoc.write('<div style="background:#F58320;position:relative; overflow: hidden; width: 100px; height: 34px;">');
        myDoc.write("<span style='position: absolute; color: #ffffff; line-height: 34px; font-size:14px; font-family: PMSemiBold,sans-serif;text-align:center; width: 100%;'>Choose File</span>");
        myDoc.write('<input name="nicImage" type="file" style="opacity: 0; height: 34px; width: 100px;" />');
        myDoc.write('</div>');
